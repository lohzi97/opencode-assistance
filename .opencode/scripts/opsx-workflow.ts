...
const PHASES: PhaseDef[] = [
  { id: "review-proposal", skill: "openspec-review-proposal", aliasBase: "reviewer-proposal", family: "self-heal", capKey: "selfHeal", provider: "deepseek", model: "deepseek-flash", variant: "max" },
  { id: "apply", skill: "openspec-apply-change", aliasBase: "implementer", family: "apply", capKey: "apply", provider: "deepseek", model: "deepseek-flash", variant: "max" },
  { id: "apply-resume", skill: "openspec-apply-resume", aliasBase: "reviewer-impl", family: "self-heal", capKey: "selfHeal", provider: "deepseek", model: "deepseek-flash", variant: "max" },
  { id: "test", skill: "openspec-test", aliasBase: "tester", family: "finding", capKey: "testFix", provider: "deepseek", model: "deepseek-flash", variant: "max" },
  ...
  { id: "test-regression", skill: "openspec-test", aliasBase: "tester-regress", family: "finding", capKey: "testFix", provider: "deepseek", model: "deepseek-flash", variant: "max" },
  { id: "align", skill: "openspec-align", aliasBase: "aligner", family: "self-heal", capKey: "selfHeal", provider: "deepseek", model: "deepseek-flash", variant: "max" },
  { id: "archive", skill: "openspec-archive-change", aliasBase: "archiver", family: "archive", capKey: "selfHeal", provider: "deepseek", model: "deepseek-flash", variant: "max" },
];
