# openchamber-service Specification

## Purpose

Define the durable contract for integrating OpenChamber into the opencode-assistant lifecycle scripts: installation, configuration, start, stop, uninstall, and browser-open behavior. This spec covers the shell-script orchestration layer that manages OpenChamber as a companion service alongside OpenCode.
