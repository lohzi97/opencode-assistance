...
### Requirement: install.sh clones and prepares the forked computer-control-mcp repo
...
### Requirement: opencode.json launches the forked MCP via relative path
...
### Requirement: uninstall.sh removes the cloned repo
